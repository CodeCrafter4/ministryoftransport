  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (transportRes.status === 'fulfilled' && transportRes.value.ok) {
        ...
        setStats(prev => ({
          ...prev,
          transport: { routes: 28, activeRoutes: 24 }
        }))
      }
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.transport.routes}</p>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="font-medium text-purple-900">Manage Routes</span>
          </Link>
        </div>
      </div>
